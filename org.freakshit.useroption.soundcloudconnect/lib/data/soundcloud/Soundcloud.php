...
class Services_Soundcloud
{
    ...
    public function updatePlaylist($playlistId, $trackIds, $optionalPostData = null)
    {
        ...
        $postData = array_map('track_string_callback', $trackIds);
    ...
    /*
     * The orignal code of the Soundcloud API uses an inline-defined function
     * in updatePlaylist(), which isn't supported by PHP 5.2. Therefore, this
     * function has been defined.
     */
    protected function track_string_callback ($track)
    {
